<template>
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!finalizado">
				...
				<rotulo :nome="'armazenar dados ?'">	
					<span>
						Sim<input type="radio" value="sim" >
					</span>
					<span>
						Não<input type="radio" value="nao" >
					</span>
				</rotulo>

				<button @click.prevent="finalizado = !finalizado">Enviar</button>
			...
			<div class="painel" v-if="finalizado">
